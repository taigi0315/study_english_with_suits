#!/usr/bin/env python3
"""
Create final educational video with slides only (simplified approach)
"""
...
def process_all_videos():
    """Process all expression videos with educational slides only"""
    ...
    logger.info(f"Processing {len(video_files)} videos with educational slides...")
